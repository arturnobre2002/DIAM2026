...
const Intro = () => {
    const [tempo, setTempo] = useState("A calcular tempo restante para o começo do evento...");
    ...
    useEffect( () => {
        function atualizarContador() {
            ...
            if (dif<0) {
                setTempo("O Eklektikfest já começou!");
                return;
            }
        ...
        setTempo("Faltam " + dias + " dias, " + horas + "h " + minutos + "m " + segundos + "s para o evento começar!");
        }
    ...
    return (
        <section className="text-center my-5">
            ...
            <h4 id="contador" className="mt-4">{tempo}</h4>
        </section>
    )
}
